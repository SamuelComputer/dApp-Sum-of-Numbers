...
## About
<p>
    This is decentralized application (dapp) for generating sum of numbers between two values powered by <a href="https://docs.cartesi.io/cartesi-rollups/1.3/">cartesi</a> rollups technology.
</p>
...
#### Advanced handlers
```
description — generate a sum of number between two values.
