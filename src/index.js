...
function getSumOfTwoNumbers(firstNum, secondNum) {
...
async function handle_advance(data) {
  ...
  const result = getSumOfTwoNumbers(firstNumber, secondNumber);
...
async function handle_inspect(data) {
  ...
  const responseObject = "Inspect route not implemented for Sum of two numbers";
